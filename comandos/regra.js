...
const embed1 = new Discord.MessageEmbed()
        ...
        .setDescription(" | Serão punições primárias relativas à conduta de um usuário, será um tipo de punição mais leve. A punição poderá ser substituída por um aviso em mensagem ao infrator para que não cometa novamente o erro, pois é compreensível que todos de vez em quando podem vir a cometer um deslize e acabar sendo punidos. O infrator ganhará o cargo 1ADV para estar ciente do seu erro e não vir a cometê-lo novamente.")
        .addField("Tempo de Punição:", " Até 24 horas.")
        await message.channel.send(embed2);

        const embed3 = new Discord.MessageEmbed()
        .setColor("#e28d2f")
        .setTitle("Infração Nível 2.")
        .setDescription(" | O usuário que ficar infringindo as regras do servidor cairá nesse nível de infração, receberá o cargo 2ADV e poderá ficar mutado por até 2 dias, então tomem bastante cuidado para não serem reincidentes.")
        .addField("Tempo de Punição:", " Até 48 horas.")
        await message.channel.send(embed3);

        const embed4 = new Discord.MessageEmbed()
        .setColor("#d80202")
        .setTitle("Infração Nível 3.")
        .setDescription(" | Então você é um menino levado? Temos uma surpresinha para você, este é o último nível de infração, o usuário que chegar a esse ponto estará no alerta máximo, receberá o cargo de 3ADV e depois disso poderá ser banido do servidor caso seja reincidente.")
        .addField("Tempo de Punição:", " Até 72 horas.")
        ...
        .setColor("#d80202")
        .setTitle(" | Regras de Banimento Imediato!")
        ...
        .addField("⠀", "**(14) ➥** Entrar no servidor com o intuito de fazer baderna ou ocasionar intriga com outros usuários é passivo de banimento. Isso vale também para usuários que desejam fazer raid no servidor -=Lab-Dark=-, juntamente com aqueles que fazem ou fizeram em outros servidores.")
        .addField("⠀", "**(15) ➥** Assédio pesado é passivo de banimento imediato.")
        .addField("⠀", "**(16) ➥** Caso o intuito da sua entrada no servidor seja mera divulgação de servidores Discord ou qualquer outro tipo de informação para benefício próprio, isso acarretará em banimento imediato. Isso vale tanto para o privado quanto para os chats do server -MineBS=-.")
